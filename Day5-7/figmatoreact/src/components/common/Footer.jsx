    ...
    <footer className="bg-gray-100 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">WebbyPages</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/components" className="text-gray-600 hover:text-blue-600">Components</Link></li>
              <li><Link to="/app-builder" className="text-gray-600 hover:text-blue-600">App Builder</Link></li>
              <li><Link to="/design-system" className="text-gray-600 hover:text-blue-600">Design System</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/docs" className="text-gray-600 hover:text-blue-600">Documentation</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-500 text-center">© {new Date().getFullYear()} WebbyPages. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
